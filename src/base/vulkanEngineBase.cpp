...
std::vector<const char*> VulkanEngineBase::args;

VkResult VulkanEngineBase::createInstance()
{
...
std::string VulkanEngineBase::getWindowTitle() const
{
...
void VulkanEngineBase::createCommandBuffers()
{
...
void VulkanEngineBase::destroyCommandBuffers()
{
	vkFreeCommandBuffers(device, cmdPool, static_cast<uint32_t>(drawCmdBuffers.size()), drawCmdBuffers.data());
}

std::string VulkanEngineBase::getShadersPath() const
{
	//return getShaderBasePath() + shaderType + "/";
	return getShaderBasePath();
}

void VulkanEngineBase::createPipelineCache()
{
...
VkPipelineShaderStageCreateInfo VulkanEngineBase::loadShader(std::string fileName, VkShaderStageFlagBits stage)
{
...
void VulkanEngineBase::nextFrame()
{
...
void VulkanEngineBase::renderLoop()
{
...
void VulkanEngineBase::updateOverlay()
{
	if (!settings.overlay)
		return;
...
void VulkanEngineBase::prepareFrame(bool waitForFence)
{
...
void VulkanEngineBase::submitFrame(bool skipQueueSubmit)
{
	if (!skipQueueSubmit) {
...
VulkanEngineBase::VulkanEngineBase()
{
...
bool VulkanEngineBase::initVulkan()
{
...
void VulkanEngineBase::setupConsole(std::string title)
{
	AllocConsole();
...
void VulkanEngineBase::setupDPIAwareness()
{
...
HWND VulkanEngineBase::setupWindow(HINSTANCE hinstance, WNDPROC wndproc)
{
...
void VulkanEngineBase::keyPressed(uint32_t) {}

void VulkanEngineBase::mouseMoved(double x, double y, bool & handled) {}

void VulkanEngineBase::createSynchronizationPrimitives()
{
...
void VulkanEngineBase::createCommandPool()
{
...
void VulkanEngineBase::getEnabledExtensions() {}

void VulkanEngineBase::windowResize()
{
	if (!prepared)
	{
		return;
...
void VulkanEngineBase::handleMouseMove(int32_t x, int32_t y)
{
...
void VulkanEngineBase::windowResized() {}

void VulkanEngineBase::createSurface()
{
#if defined(_WIN32)
...
void VulkanEngineBase::createSwapChain()
{
