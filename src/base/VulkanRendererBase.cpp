...
std::string VulkanRendererBase::getWindowTitle() const
{
...
void VulkanRendererBase::nextFrame()
{
...
void VulkanRendererBase::renderLoop()
{
...
void VulkanRendererBase::prepareFrame(bool waitForFence)
{
...
HWND VulkanRendererBase::setupWindow(HINSTANCE hinstance, WNDPROC wndproc)
{
...
void VulkanRendererBase::handleMessages(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
...
void VulkanRendererBase::keyPressed(uint32_t) {}

void VulkanRendererBase::mouseMoved(double x, double y, bool & handled) {}
...
void VulkanRendererBase::handleMouseMove(int32_t x, int32_t y)
{
...
void VulkanRendererBase::windowResized() {}
